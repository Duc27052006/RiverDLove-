...
│			                                                 │
├────────────────────────────────────────────────────────────────────────┤
│ © Copyright 2022 - Việt Đức - Version 3.6 (14/12/2021)                  │
├────────────────────────────────────────────────────────────────────────┤
│  │
│ FB: https://www.facebook.com/VietDuc uoc die                              │
│ Github: https://github.com/Duc27052006                               │
│ Gmail: ducrename2705@gmail.com                                              │
│                                                        │
├────────────────────────────────────────────────────────────────────────┤
│ Bạn không thể tấn công trang web của người khác nếu không có sự đồng ý!│
├────────────────────────────────────────────────────────────────────────┤
│ Dựa trên CC-attack của Việt Đức                                        │
└────────────────────────────────────────────────────────────────────────┘''')
